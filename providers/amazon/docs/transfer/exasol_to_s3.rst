...
Use the ``ExasolToS3Operator`` transfer to copy the data from an Exasol database to an
Amazon Simple Storage Service (S3) file.
...
This operator exports the result of a query, or the full contents of a table, from an Exasol
database to an Amazon S3 file.
...
* `pyexasol documentation <https://github.com/exasol/pyexasol>`__
